...
#   @micropython.native
  ...
  def _reset(self):
    ...
    self.dc(0)
    self.reset(1)
    time.sleep_ms(100)  # Changed from sleep_us(500) to sleep_ms(100)
    self.reset(0)
    time.sleep_ms(100)  # Changed from sleep_us(500) to sleep_ms(100)
    self.reset(1)
    time.sleep_ms(100)  # Changed from sleep_us(500) to sleep_ms(100)
...
#                             0x30, 0x39, 0x3f, 0x00, 0x07, 0x03, 0x10])
  ...
  def initr(self):
    ...
    self._writecommand(TFT.SWRESET)              # Software reset.
    time.sleep_ms(150)                            # Changed from sleep_us(150) to sleep_ms(150)
    self._writecommand(TFT.SLPOUT)               # Out of sleep mode.
    time.sleep_ms(500)                            # Changed from sleep_us(500) to sleep_ms(500)
    ...
    time.sleep_ms(10)                             # Changed from sleep_us(10) to sleep_ms(10)
    ...
    self._writecommand(TFT.MADCTL)               # Memory Data Access Control
    data1[0] = 0xC8
    self._writedata(data1)
    ...
    self._writecommand(TFT.DISPON)
    time.sleep_ms(100)                            # Changed from sleep_us(100) to sleep_ms(100)
