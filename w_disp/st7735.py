...
class TFT(object):
    ...
    ORANGE = TFTColor(0xFF, 0xA5, 0x00)   # Orange
    GOLD = TFTColor(0xFF, 0xD7, 0x00)     # Gold
    PINK = TFTColor(0xFF, 0xC0, 0xCB)     # Pink
    MAGENTA = TFTColor(0xFF, 0x00, 0xFF)  # Magenta
    LIME = TFTColor(0x00, 0xFF, 0x00)     # Lime
    TEAL = TFTColor(0x00, 0x80, 0x80)     # Teal
    OLIVE = TFTColor(0x80, 0x80, 0x00)    # Olive
    CHOCOLATE = TFTColor(0xD2, 0x69, 0x1E) # Chocolate
    TURQUOISE = TFTColor(0x40, 0xE0, 0xD0) # Turquoise
    INDIGO = TFTColor(0x4B, 0x00, 0x82)    # Indigo
